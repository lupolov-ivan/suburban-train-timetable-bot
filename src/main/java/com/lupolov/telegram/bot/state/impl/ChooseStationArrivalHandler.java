...
public class ChooseStationArrivalHandler implements BotStateHandler {
    ...
    public SendMessage handleMessage(Message message) {
        ...
        var arrivalStationNamePart = message.getText();
        var chatId = message.getChatId();
        var reply = messageService.getReplyMessage(chatId, "reply.error", ERROR.toString());

        try {
            var stations = stationBookService.getStationListByNamePart(arrivalStationNamePart);
            ...
            if(stations == null) {
                ...
                userDataCache.setBotStateForUser(userId, SHOW_SEARCH_RESULT);
            }
        } catch (Exception e) {
